...
SVG = HIER.parent / "audiodesk" / "assets" / "audiodesk.svg"
...
def main() -> int:
    ...
    write_ico(ziel / "audiodesk.ico", ziel / "ico-teile")
    ordner = write_png_set(ziel / "audiodesk.iconset")
    print(f"geschrieben: {ziel / 'audiodesk.ico'}")
    print(f"geschrieben: {len(ordner)} PNGs in {ziel / 'audiodesk.iconset'}")
    print("Auf macOS daraus die .icns bauen:")
    print(f"  iconutil -c icns {ziel / 'audiodesk.iconset'}")
    return 0
