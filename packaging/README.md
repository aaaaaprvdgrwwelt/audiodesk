...
iconutil -c icns packaging/audiodesk.iconset  # nur auf macOS
pyinstaller packaging/audiodesk.spec --noconfirm --clean
```

Pillow ist nur fürs Icon-Bauen nötig (Multi-Size-.ico) - audiodesk selbst
...
```
iscc /DVersion=0.2.0 packaging\audiodesk.iss
```

## Was mitgeliefert wird

Anders als bei den Geschwistern bleibt `PySide6.QtMultimedia` in der Spec -
das macht die eigentliche Audio-Wiedergabe (FFmpeg-Backend, in Qt 6
eingebaut, keine externe Installation nötig).
